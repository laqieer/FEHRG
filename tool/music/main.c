...
struct Song {
    ...
    unsigned short priority2; // priority1 == priority2
};
...
int main() {
    ...
    for (int i = 0; i < num; i++)
        printf("{&Song%03d, MUSIC_PLAYER_%d},\n", i, songs[i].priority1);
    printf("\n");
    for (int i = 0; i < num; i++)
        printf("extern const struct SongHeader Song%03d;\n", i);
    printf("\n");
    for (int i = 0; i < num; i++)
        printf("Song%03d = 0x%X;\n", i, songs[i].tracks);
    printf("\n");
    for (int i = 0; i < num; i++)
        printf("#define SONG%03d %d\n", i, i);
