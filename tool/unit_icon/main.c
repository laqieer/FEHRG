...
#include "../../include/standing_unit_icon.h"
#include "../../include/moving_unit_icon.h"
...
const char * const StandingUnitIconClasses[] = {
	"EliwoodLord",
	"LynLord",
	"HectorLord",
	"KnightLord",
...
const char * const MovingUnitIconClasses[] = {
	"EliwoodLord",
	"LynLord",
	"HectorLord",
	"KnightLord",
...
const char * const StandingUnitIconSizes[] = {
    "16x16",
    "16x32",
    "32x32",
};
...
int main() {
    printf("--- standingUnitIcons ---\n\n");
    int num = sizeof(StandingUnitIconClasses) / sizeof(StandingUnitIconClasses[0]);
    for (int i = 0; i < num; i++)
