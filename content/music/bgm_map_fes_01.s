        ...
        .equ    bgm_map_fes_01_grp, voicegroup000
        .equ    bgm_map_fes_01_pri, 0
        .equ    bgm_map_fes_01_rev, 0
        .equ    bgm_map_fes_01_key, 0

        .section .rodata
        .global bgm_map_fes_01
        .align  2

@****************** Track 0 (Midi-Chn.0) ******************@

bgm_map_fes_01_0:
        .byte   KEYSH , bgm_map_fes_01_key+0
@ 000   ----------------------------------------
        .byte   TEMPO , 136/2
bgm_map_fes_01_0_LOOP:
        .byte           VOICE , 0
        .byte           VOL   , 100
        .byte           N22   , As1 , v064
        .byte   W24
...
bgm_map_fes_01:
        .byte   1                       @ Num Tracks
        .byte   0                       @ Unknown
        .byte   bgm_map_fes_01_pri     @ Priority
        .byte   bgm_map_fes_01_rev     @ Reverb

        .word   bgm_map_fes_01_grp    

        .word   bgm_map_fes_01_0
