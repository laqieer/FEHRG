...
extern struct BattleStats BattleStats;

extern struct BattleUnit BattleActor;
extern struct BattleUnit BattleTarget;

extern struct BattleHit BattleHits[BATTLE_HIT_MAX];
extern struct BattleHit* BattleHitIterator;

extern struct BattleUnit *BattleUnits[];
extern u8 BattleCharacterIds[];
